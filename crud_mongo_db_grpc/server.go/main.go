...
func initMovies() {
	movie1 := &pb.MovieInfo{Id: "1", Isbn: "0593310438",Title: "The Batman", Director: &pb.Director{Firstname: "Matt", Lastname: "Reeves"}}
	movie2 := &pb.MovieInfo{Id: "2", Isbn: "3430220302",Title: "Doctor Strange in the Multiverse of Madness",Director: &pb.Director{Firstname: "Sam",Lastname: "Raimi"}}
